...
public class SABREv3DicomObjectIdentifier extends CompositeDicomObjectIdentifier {
    ...
    public SABREv3DicomObjectIdentifier() {
        super(new FixedDicomProjectIdentifier("SABREv3"), subjectExtractors, sessionExtractors, aaExtractors);
    }
